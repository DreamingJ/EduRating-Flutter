...
class TeachEdit extends StatefulWidget {
  final TeachModel? teachModel;

  const TeachEdit({Key? key, this.teachModel}) : super(key: key);
...
class PersonEditState extends State<TeachEdit> {
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  TeachModel? _teachModel = TeachModel();
      ...
      children: <Widget>[
        CryButton(
          ...
          onPressed: () {
            ...
            form.save();
            TeachApi.saveOrUpdate(_teachModel!.toMap()).then((res) {
