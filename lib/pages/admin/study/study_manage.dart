...
class StudyManagePage extends StatefulWidget {
  const StudyManagePage({Key? key}) : super(key: key);

  @override
  State<StudyManagePage> createState() => _TeachManagePageState();
}

class _TeachManagePageState extends State<StudyManagePage> {
  //管理当前widget的state
